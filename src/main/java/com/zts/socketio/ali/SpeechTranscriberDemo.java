...
public class SpeechTranscriberDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        AccessToken accessToken = new AccessToken("kqZpof5RsV52y28g", "JT6vtVNLqMWbq91O7xSN4ObVDo4ExQ");
        accessToken.apply();

        String appKey = "n7WeQj4ACKglzInX";
        String token = accessToken.getToken();
        String url = "ws://nls-gateway.cn-shanghai-internal.aliyuncs.com/ws/v1";
        ...
        InputStream ins = new FileInputStream(new File("D:\\DSAdpcmPlayer\\nls-sample-16k.wav"));
        if (null == ins) {
